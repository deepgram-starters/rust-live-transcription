...
Rust (Axum) demo app for Deepgram Live Transcription.
...
```
feat(rust-live-transcription): add diarization support
fix(rust-live-transcription): resolve WebSocket close handling
refactor(rust-live-transcription): simplify session endpoint
